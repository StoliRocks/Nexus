...
class IngestControl:
    ...
    def to_dict(self) -> dict:
        """
        Converts the IngestControl instance to a dictionary
        Returns:
            dict: Dictionary representation of the IngestControl
        """
        return {
    ...
    @classmethod
    def from_dict(cls, data: dict) -> "IngestControl":
        try:
            return cls(
    ...
    @classmethod
    def from_control_ingestion_status(
        cls,
        reference_id: str,
        ingestion_configuration_id: str,
        session_id: str,
